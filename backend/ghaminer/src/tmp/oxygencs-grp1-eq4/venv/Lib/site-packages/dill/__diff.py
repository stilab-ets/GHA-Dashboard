...
dont_memo = set(
    id(i) for i in (memo, sys.modules, sys.path_importer_cache, os.environ, id_to_obj)
)
...
def get_seq(
    ...
    if o_type in cache:
        ...
        hsattr(obj, "__contains__")
        and hsattr(obj, "__iter__")
        and hsattr(obj, "__len__")
        and hsattr(o_type, "__contains__")
        and hsattr(o_type, "__iter__")
        and hsattr(o_type, "__len__")
    ):
        cache[o_type] = True
        if hsattr(obj, "copy"):
            return obj.copy()
