...
echo "1. Extraire des données : curl 'http://localhost:3000/api/extraction?repo=facebook/react'"
echo "2. Voir les métriques : curl 'http://localhost:3000/api/github-metrics?repo=facebook/react'"
echo "3. Charger l'extension Chrome et tester sur GitHub"